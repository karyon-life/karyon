...
import type { TreeseedCommandGroup, TreeseedCommandSpec } from './types.js';
...
function groupedCommands() {
	const groups = new Map<TreeseedCommandGroup, TreeseedCommandSpec[]>();
...
export function renderUsage(spec: TreeseedCommandSpec) {
