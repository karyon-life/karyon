import type { TreeseedCommandOptionSpec, TreeseedCommandSpec, TreeseedParsedInvocation } from './types.js';

function optionKey(spec: TreeseedCommandOptionSpec) {
	return spec.name;
}

export function parseTreeseedInvocation(command: TreeseedCommandSpec, argv: string[]): TreeseedParsedInvocation {
...
export function validateTreeseedInvocation(command: TreeseedCommandSpec, invocation: TreeseedParsedInvocation): string[] {
	const errors: string[] = [];
