...
3. <a id="ref-3"></a>Seth, A. K., et al. (2020). *Curious Inferences: Reply to Sun and Firestone on the Dark Room Problem*. Trends in Cognitive Sciences. [https://perception.jhu.edu/files/PDFs/20_DarkRoom/SethEtAl_DarkRoomReply_TiCS_InPress.pdf](https://perception.jhu.edu/files/PDFs/20_DarkRoom/SethEtAl_DarkRoomReply_TiCS_InPress.pdf)
